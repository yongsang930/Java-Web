...
public class OrderAddController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Order o = new Order();
		o.setPro_num(Integer.valueOf(request.getParameter("num")));
		o.setOrder_num(Integer.valueOf(request.getParameter("quantity")));
		o.setTotal_price(Integer.valueOf(request.getParameter("total_price")));
		o.setO_id(o_id);
		o.setO_state(Integer.valueOf(request.getParameter("o_state")));
		service.addOrder(o);
